...
export default function Login() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <Hero />
      <main className="flex-grow py-10 justify-evenly">
        <div className="container grid grid-cols-1 md:grid-cols-3 gap-6 ">
          ...
          <Card title="Service 2" description="Description du service 4." />
          <Card title="Service 3" description="Description du service 5." />
        </div>
      </main>
      <Footer />
    </div>
